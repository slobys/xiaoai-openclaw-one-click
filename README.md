...
```sh
OLLAMA_BASE_URL=http://192.168.2.100:11434/v1 OLLAMA_MODEL=gemma3:4b OLLAMA_TIMEOUT_MS=120000 OLLAMA_NUM_PREDICT=120 OLLAMA_KEEP_ALIVE=30m xiaoai-openclaw
```
